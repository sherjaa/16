...
if (D > 0){
    ...
    innerHTML = ('<hr class="hr">')
    alert(x1);
    alert(x2);
    masala.style.cssText = 'padding: 25px;';
} else if (0 === D){
...
murojat.innerHTML = '<a href="https://t.me/sherja_0417" target="_blank"><i class="bx bxl-telegram"></i></a>';
murojat.innerHTML += '<a href="https://www.instagram.com/akhmadjan0ff_0417/" target="_blank"><i class="bx bxl-instagram"></i></a>';
murojat.innerHTML += '<a href="https://sherjaa.github.io/15/" target="_blank"><i class="bx bx-phone"></i></a>';
murojat.innerHTML += '<a href="https://github.com/sherjaa" target="_blank"><i class="bx bxl-github"></i></a>';
